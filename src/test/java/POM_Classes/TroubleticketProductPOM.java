...
public class TroubleticketProductPOM {
...
//		String SalesEnddate=elib.getDataFromExcel("product", 1, 4);
		...
		TroubleticketProductPage tc=new TroubleticketProductPage(driver);
		tc.getTroubleticketbtn().click();
		tc.getCreatetroubleticketbtn().click();
		tc.getTitlename().click();
		
		tc.createtroubleticket(Troubleticketname, productname, driver);
		Thread.sleep(2000);
